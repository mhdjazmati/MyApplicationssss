...
/**
 * Created by 7modeee on 2/16/2017.
 */
/**
Skip to content
        This repository
...
Sign out
        Watch 16
        Star 78
        Fork 49 abodehq/Pray-Times
        Code  Issues 4  Pull requests 1  Projects 0  Wiki  Pulse  Graphs
        Branch: master Find file Copy pathPray-Times/Code/v2/java/PrayTime.java
        465910d  on Aug 21, 2012
@abodehq abodehq No commit message
        1 contributor
        RawBlameHistory
        958 lines (759 sloc)  27.5 KB
**/
//--------------------- Copyright Block ----------------------
/*
...
public class PrayerTime {
    ...
    /**
     */
    static ArrayList<String> calcPrayer(double latitude, double longitude) {
       // latitude = 36.2068887;
      //  longitude = 37.1502068;
        ...
        int[] offsets = {0, -3, 0, 0, 0, 0, 0}; // {Fajr,Sunrise,Dhuhr,Asr,Sunset,Maghrib,Isha}
        ...
        ArrayList<String> prayerTimes = prayers.getPrayerTimes(cal,
                latitude, longitude, prayers.getTimeZone1());
        ArrayList<String> prayerNames = prayers.getTimeNames();
        System.out.println(prayers.getTimeZone1());
